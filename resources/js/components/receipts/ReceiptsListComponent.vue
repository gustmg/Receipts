<template>
	<div class="row">
		<div class="col s12" v-show="receipts.length > 0" v-for="(receiptGroup, index) in groupedReceipts">
			<div class="row">
				<h6 class="col s12 date-header"><b>{{formatDate(receiptGroup[0].receipt_date)}}</b></h6>
				<div class="col m3" v-for="(receipt, index) in receiptGroup">
					<div class="card hoverable hoverable-card selectable receipt-card">
						<div class="card-content">
							...
							<a class="waves-effect waves-light btn blue" v-on:click="reprintReceipt(receipt.receipt_id)">Reimprimir ticket</a>
						</div>
					</div>
				</div>
			</div>
