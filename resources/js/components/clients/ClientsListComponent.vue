<template>
	<div class="row">
		...
		<div>
			<h5 
				v-show="filteredClients.length == 0 && this.$parent.searchClient != '' " 
				class="center grey-text">
				Búsqueda sin resultados.
			</h5>
			<h5 v-show="clients.length == 0 && this.$parent.searchClient == ''" class="center grey-text">No hay clientes registrados.</h5>
		</div>
